...
def prepare():
    ...
    if osType == 'Linux':
        ...
        os.system('export LD_PRELOAD="' + os.environ['LD_PRELOAD'] + '"')
        ...
        os.system('export LD_LIBRARY_PATH="' + os.environ['LD_LIBRARY_PATH'] + '"')
    elif osType == 'Darwin':
        ...
        os.system('export DYLD_FALLBACK_LIBRARY_PATH="' + os.environ['DYLD_FALLBACK_LIBRARY_PATH'] + '"')
